...
export class PathMaker {
  ...
  public lineTo(x: number, y: number) {
    this.path.cmds.push({
      cmd: "L",
      args: [x + (Math.random() - 0.5) / 1e2, y + (Math.random() - 0.5) / 1e2]
    });
  }
  public cubicBezierCurveTo(
    ...
    this.path.cmds.push({
      cmd: "C",
      args: [
        c1x + (Math.random() - 0.5) / 1e2,
        c1y + (Math.random() - 0.5) / 1e2,
        c2x + (Math.random() - 0.5) / 1e2,
        c2y + (Math.random() - 0.5) / 1e2,
        x + (Math.random() - 0.5) / 1e2,
        y + (Math.random() - 0.5) / 1e2
      ]
    });
  }
  public quadraticBezierCurveTo(cx: number, cy: number, x: number, y: number) {
    this.path.cmds.push({
      cmd: "Q",
      args: [
        cx + (Math.random() - 0.5) / 1e2,
        cy + (Math.random() - 0.5) / 1e2,
        x + (Math.random() - 0.5) / 1e2,
        y + (Math.random() - 0.5) / 1e2
      ]
    });
